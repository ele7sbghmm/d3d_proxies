...
namespace Shar {
	...
	enum DynaLoadState : uint32_t { /**/ };
	enum eExportedState : uint32_t { /**/ };
	enum pddiDisplayMode : uint32_t { /**/ };
	enum ErrorState : uint32_t { /**/ };
	enum Resolution : uint32_t { /**/ };
	enum StateEnum : uint32_t { /**/ };
	enum Dirty : uint32_t { /**/ };
	enum ElementType: uint32_t{ /**/ };
	enum eTerrainType : uint32_t { /**/ };
	enum Role : uint32_t { /**/ };
	...
	struct Context : EventListener { StateEnum m_state; };
	struct GameFlow {
